...
num = int(input("Enter your greater than number:"))
if num>100:
    print("greater than 100:")    # greater than

6. Display a message if temperature exceeds 45°C.

temperature = int(input('Enter temperature:'))
if temperature>45:
    print('temperature exceedas 45c:',temperature)
...
marks=int(input("based on marks:"))
if marks>600:
    print("pass")
else:
    print("fail")
